          ...
          >
            ...
            {dropdownOpen && (
              <div className="absolute left-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg">
                <Link href="/services/mainland" className="block px-4 py-2 text-gray-700 hover:bg-blue-50">Mainland</Link>
                ...
                <Link href="/services/golden-visa" className="block px-4 py-2 text-gray-700 hover:bg-blue-50">Golden Visa</Link>
              </div>
            )}
          </div>
